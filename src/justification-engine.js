...
function assembleFreeExamJustification(examName, { form = {}, clinicalState = {} } = {}) {
  ...
  return normalize(
    ...
    `DIANTE DO QUADRO CLÍNICO APRESENTADO E DA HIPÓTESE DIAGNÓSTICA DE ${hypotheses}, ` +
    `SOLICITO O EXAME ACIMA PARA COMPLEMENTAÇÃO DA INVESTIGAÇÃO DIAGNÓSTICA E AUXÍLIO À DEFINIÇÃO DE CONDUTA.`
  );
}
